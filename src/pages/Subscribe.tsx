  ...
  return (
    <div className="min-h-screen bg-blur bg-cover bg-no-repeat flex flex-col items-center">
      <div className="w-full max-w-[1100px] flex items-center justify-between mt-20 mx-auto">
        ...
        <div className="p-8 bg-gray-700 border  border-gray-500 rounded" onSubmit={handleSubscriber}>
          ...
          <form action="" className="flex flex-col gap-2 w-full">
            ...
            <input className="bg-gray-900 rounded px-5 h-14" type="email" placeholder="Seu e-mail" onChange={event => setEmail(event.target.value)} />
